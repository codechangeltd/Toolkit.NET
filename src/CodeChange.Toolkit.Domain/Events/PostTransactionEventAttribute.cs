namespace CodeChange.Toolkit.Domain.Events
{
    ...
    /// <summary>
    /// Represents an attribute that decorates a domain event as post-transaction
    /// </summary>
    /// <remarks>
    /// Post-transaction domain events are raised after a transaction is committed.
    ...
    /// 
    /// By default, domain event handlers are post-transaction handlers.
    /// </remarks>
    public class PostTransactionEventAttribute : Attribute { }
}
