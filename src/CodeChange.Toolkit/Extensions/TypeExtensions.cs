...
public static class TypeExtensions
{
    ...
    public static bool CanConvert(this Type fromType, Type toType, object fromObject)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (canConvertProperty != null)
                {
                    var propertyValue = canConvertProperty.GetGetMethod()?.Invoke(instance, null);
                    var canConvert = propertyValue != null && (bool)propertyValue;
    ...
    public static object? GetPropertyValue(this Type type, string propertyName, object obj)
    {
        ...
        var value = property != null ? property.GetValue(obj) : default;
